...
void find_next_destenation( vector<locations> input, vector<int> &location_check, vector<int> &start, vector<int> &durations,int current_time=480)
{
...
int main(int argc, char *argv[])
{
	...
	find_next_destenation( location_data, gone_location, start_times, durations);
