...
{
	int name_index = searchInVector(titles, "name");
	int opentime_index = searchInVector(titles, "openingTime");
	int closetime_index = searchInVector(titles, "closingTime");
	int rank_index = searchInVector(titles, "rank");
...
int find_nearest(int current_time, vector<int> opentimes)
{
	...
	int min = findMin(late_opentimes);
	return min;
}
